    ...
    <div class="mx-auto flex max-w-6xl items-center justify-center">
      <div class="w-full max-w-md rounded-[2rem] border border-white/10 bg-slate-900/80 p-8 shadow-2xl shadow-cyan-500/10 backdrop-blur">
        <div class="mb-6">
          ...
          <p class="mt-2 text-sm text-slate-400">Acesse sua workspace e siga seu fluxo.</p>
        </div>
        ...
        <p class="mt-5 text-center text-sm text-slate-400">
          Novo por aqui?
          <NuxtLink to="/register" class="font-semibold text-cyan-300">Crie uma conta</NuxtLink>
        </p>
      </div>
    </div>
  </div>
